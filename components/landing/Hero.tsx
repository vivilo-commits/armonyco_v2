         ...
         <div className="relative w-full max-w-[1440px] mx-auto bg-zinc-950 rounded-[3rem] overflow-hidden min-h-[90vh] flex items-center shadow-[0_0_50px_rgba(0,0,0,0.3)] border border-white/5">
            ...
            <div className="container mx-auto px-8 md:px-16 relative z-10 w-full h-full py-20 md:py-24">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center h-full">
                  ...
                  <div className={`space-y-10 text-center lg:text-left transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                     <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-sm group cursor-default hover:bg-white/10 transition-colors">
                        ...
                        <span className="text-xs font-semibold tracking-wider text-zinc-300 uppercase">System of Truth</span>
                     </div>

                     <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-white leading-[0.95] tracking-tight">
                        AI Trust & <br />
                        <span className="font-normal text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-200 to-zinc-400 italic font-serif">
                           Control Layer
                        </span>
                     </h1>

                     <p className="text-xl text-zinc-400 max-w-xl mx-auto lg:mx-0 leading-relaxed font-light">
                        Armonyco is the governance engine that transforms black-box AI into verifiable, compliant, and autonomous operations.
                     </p>

                     <div className="flex flex-col sm:flex-row gap-8 justify-center lg:justify-start items-center pt-8">
                        <AnimatedButton onClick={onStartNow} text="Start Now" width="180px" expanded={true} className="shadow-[0_0_30px_rgba(212,175,55,0.3)]" />
                        <a href="#manifesto" className="text-zinc-400 hover:text-white transition-colors font-medium text-lg">
                           Manifesto
                        </a>
                     </div>

                     <div className="pt-10 flex flex-col items-center lg:items-start gap-4 opacity-100 transition-all duration-500">
                        <div className="flex items-center gap-4">
                           <div className="flex -space-x-4">
                              {[
                                 '●', '■', '◆', '▲'
                              ].map((symbol, i) => (
                                 <div key={i} className={`w-12 h-12 rounded-full border-[3px] border-zinc-950 bg-zinc-900 flex items-center justify-center text-lg text-zinc-600 font-bold shadow-lg`}>
                                    {symbol}
                                 </div>
                              ))}
                              <div className="w-12 h-12 rounded-full border-[3px] border-zinc-950 bg-zinc-800 text-zinc-500 flex items-center justify-center text-xs font-bold shadow-lg">
                                 &
                              </div>
                           </div>
                        </div>
                        <div className="space-y-0.5 text-center lg:text-left">
                           <div className="text-sm text-zinc-200 font-medium tracking-wide">
                              Trusted by <span className="text-[var(--color-brand-accent)] font-bold">500+</span> Industry Leaders
                           </div>
                           <p className="text-xs text-zinc-500 font-light">
                              Standardizing AI Governance worldwide.
                           </p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className={`relative h-[600px] w-full hidden lg:block perspective-1000 scale-110 origin-center transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                     ...
                     <div className="absolute top-0 right-10 w-[300px] opacity-40 scale-90 blur-[2px] animate-float-slow z-0">
                        <Card padding="lg" noHover className="bg-zinc-900/40 border-zinc-800/50 backdrop-blur-sm">
                           <div className="flex items-center gap-3 mb-4">
                              <div className="w-8 h-8 rounded bg-zinc-800 flex items-center justify-center text-zinc-500"><Shield size={16} /></div>
                              <div>
                                 <div className="text-xs font-bold text-zinc-500 uppercase">ARS Module</div>
                                 <div className="text-[10px] text-zinc-700">Reliability System</div>
                              </div>
                           </div>
                     ...
                     {/* Main Element: Amelia (Risk Guardian) */}
                              ...
                              <div className="bg-zinc-900/50 rounded-[1.4rem] p-6 border border-white/5">
                                 <div className="flex justify-between items-start mb-8">
                                    <div className="flex items-center gap-4">
                                       ...
                                       <div>
                                          ...
                                          <div className="text-[11px] text-[var(--color-brand-accent)] uppercase tracking-[0.2em] font-bold mt-1">Risk Guardian</div>
                                       </div>
                                    </div>
                                 ...
                                 <div className="space-y-4 mb-8">
                                    <div className="flex justify-between text-xs py-2 border-b border-white/5 group-hover:border-white/10 transition-colors">
                                       ...
                                       <span className="text-white font-mono tracking-wide">Active Monitoring</span>
                                    </div>
                                    <div className="flex justify-between text-xs py-2 border-b border-white/5 group-hover:border-white/10 transition-colors">
                                       <span className="text-zinc-500 font-medium">Risk Score</span>
                                       <span className="text-[var(--color-success)] font-mono font-bold tracking-wide">Low (0.02%)</span>
                                    </div>
                                 </div>
                     ...
                     <div className="absolute bottom-24 left-8 animate-float-reverse animation-delay-2000 z-30">
                        <div className="bg-black/40 backdrop-blur-xl border border-white/10 px-5 py-4 rounded-2xl flex items-center gap-4 shadow-[0_8px_32px_rgba(0,0,0,0.2)] hover:bg-black/60 transition-colors cursor-default">
                           ...
                           <div>
                              ...
                              <div className="text-base font-mono font-bold text-white mt-0.5">24ms <span className="text-[var(--color-success)] text-[10px] ml-1 px-1.5 py-0.5 rounded-md bg-[var(--color-success)]/10">↓ 12%</span></div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="absolute bottom-10 right-4 animate-slide-up-slow animation-delay-1000 z-30 hidden xl:block">
                        <div className="bg-zinc-950/80 backdrop-blur-xl border border-white/10 p-4 rounded-xl shadow-2xl font-mono text-[9px] text-zinc-500 space-y-1 w-[200px]">
                           ...
                           <div className="text-emerald-500/80">✔ Policy check passed (A-10)</div>
                           <div className="text-zinc-400">→ Encrypting handshake...</div>
                           <div className="text-zinc-400">→ Verifying AEM hash...</div>
