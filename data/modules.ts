...
export const productModules: ProductModule[] = [
  // --- CORE COVERAGE: GUEST ---
  {
    ...
    category: 'GUEST',
    description: 'Automated guest verification. Eliminates "where is the address" WhatsApp chaos.',
    what: 'Orchestrates the pre-arrival sequence 48h before check-in.',
    why: ['Reduces support WhatsApp noise by 90%', 'Ensures 100% legal compliance before arrival', 'Sets a premium, hands-off tone'],
  ...
  },
  {
    ...
    category: 'GUEST',
    description: 'Secure access delivery. No manual code sending.',
    what: 'Releases property access information only after pre-arrival conditions are met.',
    why: ['Zero unsecured access events', 'Eliminates "I can\'t find the keys" calls', 'Full audit trail of guest entries'],
  ...
  // --- CORE COVERAGE: REVENUE ---
  {
    ...
    category: 'REVENUE',
    description: 'Calendar efficiency. Monetizes gap days.',
    what: 'Identifies unbookable gap days and offers them to current guests.',
    why: ['Converts 0-value gaps into Governed Cashflow™', 'Increases RevPAR without new acquisition costs', 'Automates extension offers via WhatsApp'],
  ...
  // --- INCIDENT PLAYBOOKS ---
  {
    ...
    category: 'PLAYBOOK',
    description: 'Emergency access. Prevents late-night emergency calls.',
    what: 'High-priority troubleshooting for smart locks and keyboxes.',
    why: ['Prevents refund claims from lock failures', 'Immediate alternative entry provided automatically', 'Protects your 24/7 reliability reputation'],
  ...
  },
  {
    ...
    category: 'PLAYBOOK',
    description: 'Regulatory compliance. Automated chasing.',
    what: 'Chases missing identity documents required by law.',
    why: ['Ensures 100% legal protection', 'Automated police reporting preparation', 'Removes manual "please send ID" friction'],
